...
const Estatisticas: React.FC = () => {
  ...
  // Encontra o último culto encerrado ou o atual mais recente
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-700">
       ...
       <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-purple-main text-white p-6 rounded-3xl shadow-xl shadow-purple-main/20">
             <p className="text-[9px] font-black uppercase tracking-widest mb-1 opacity-70">Total de Crianças Cadastradas</p>
             <p className="text-4xl font-black">{totalKids}</p>
          </div>
          
          <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
             <p className="text-[9px] font-black text-purple-main uppercase tracking-widest mb-1">Cadastros (Últimos 30 dias)</p>
             <p className="text-4xl font-black text-purple-dark">{newKids30Days}</p>
          </div>

          <div className="bg-yellow-main p-6 rounded-3xl shadow-xl shadow-yellow-main/20">
             <p className="text-[9px] font-black text-purple-dark uppercase tracking-widest mb-1 opacity-70">Total Crianças Último Culto</p>
          ...
          <div className="h-[350px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={chartData} margin={{ top: 20, right: 30, left: 0, bottom: 0 }}>
                ...
                <Tooltip 
                  cursor={{fill: '#f9f9f9'}} 
                  contentStyle={{borderRadius: '20px', border: 'none', boxShadow: '0 10px 30px rgba(0,0,0,0.1)', padding: '15px', fontSize: '12px', fontWeight: 'bold'}} 
                />
