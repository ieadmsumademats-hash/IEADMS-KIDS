    ...
    <div className="space-y-10 animate-in fade-in duration-500">
       <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          ...
          <button 
            ...
            className="bg-purple-main text-white font-black px-10 py-5 rounded-3xl shadow-xl flex items-center justify-center gap-3 hover:scale-105 transition-all text-white"
          >
       ...
       {loading ? (
         <div className="text-center py-20 text-purple-main font-bold">Carregando registros...</div>
       ) : (
       ...
       {isAdding && (
         <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-purple-dark/80 backdrop-blur-md">
            <div className="bg-white w-full max-w-3xl rounded-[3rem] p-10 shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
               <h2 className="text-3xl font-black text-purple-dark mb-10 uppercase tracking-tight text-purple-dark">Cadastro Completo</h2>
               <form onSubmit={handleSave} className="space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-6 pt-4">
                    ...
                    <button type="submit" className="bg-purple-main text-white font-black py-5 rounded-3xl shadow-xl shadow-purple-main/20 text-white">SALVAR DADOS</button>
                  </div>
               </form>
            </div>
         </div>
