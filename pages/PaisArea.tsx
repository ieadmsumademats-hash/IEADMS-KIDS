      ...
      <div className="w-full max-w-lg mt-16 space-y-6 animate-in fade-in slide-in-from-bottom-6 duration-700">
        ...
        >
          <div className="relative z-10 flex-1">
            <h2 className="text-3xl font-black mb-1 uppercase tracking-tighter">PRÉ-CHECK-IN</h2>
            <p className="text-sm font-bold opacity-80 max-w-[200px]">Já possui cadastro? Gere seu código rápido.</p>
          </div>
          <div className="bg-white/20 p-5 rounded-3xl relative z-10">{ICONS.QrCode}</div>
